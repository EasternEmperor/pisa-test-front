<template>
    <div class="big-air-controller-t2">
      <!-- 使用 Header 组件 -->
      ...
      <div class="container-box question-section">
        ...
        <div class="question-text">
          ...
          <p>
            ...
            灵活运用控制器，将温度、湿度和风量调整到目标数值。目标数值如<b>曲线图上方所示。</b><br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            ...
            <div class="influence-box" >风量</div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      sendEvent(eventType) {
        ...
        const data = {
          tableName: 1,
          htmlName: 'big_air_controller_t2',
          userName: userName,
          ithAnswer: ithAnswer,
          event: 'ACER_EVENT',
          eventType: eventType,
