<template>
    <div class="camera-controller-t2">
      <!-- 使用 Header 组件 -->
      ...
      <div class="container-box question-section">
        ...
        <div class="question-text">
          <h3>问题2: 调控照片亮度、清晰度、虚化程度和取景范围</h3>
          <p>
            三个控制器及其控制的对象如下图连线所示。<br/>
            灵活运用控制器，将照片亮度、清晰度、虚化程度和取景范围调整到目标数值。目标数值如<b>曲线图上方所示。</b><br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            ...
            <div class="influence-box" >虚化程度</div>
            <div class="influence-box" >取景范围</div>
          </div>
        </div>
  ...
  <script>
  import CameraControllerUpComponent from './camera_controller_up_component_t2.vue';
  import HeaderComponent from '@/components/Header.vue';
  import CountdownTimer from '@/components/CountdownTimer.vue';
  
  export default {
    name: 'CameraControllerT2',
    components: {
    ...
    methods: {
      drawExample() {
        ...
        this.handleBoxClick('top');
        this.handleBoxClick('virtualization');
