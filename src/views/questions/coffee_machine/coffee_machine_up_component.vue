<template>
    <div class="coffee-machine-up">
      ...
      <p>
        ...
        控制器能够控制咖啡机制作咖啡的容量、苦涩度、甜度和浓稠度，但四个控制器对咖啡容量、苦涩度、甜度和浓稠度大小的具体影响需要你自己探索。<br/>
        当你设置好控制器后，点击"调控"键，你将在咖啡容量、苦涩度、甜度和浓稠度曲线图中看到电饭煲的任何变化。<br/>
        点击"重置"键，你可以将所有控制器重置到初始设置，容量、苦涩度、甜度和浓稠度数字也将变回初始值。
      </p>
