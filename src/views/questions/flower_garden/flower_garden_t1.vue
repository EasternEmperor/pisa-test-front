<template>
    <div class="flower-garden-t1">
      ...
      <div class="container-box question-section">
        <div class="question-text">
          <h3>问题1: 控制器功能</h3>
          <p>
            通过改变滑块并调控，弄清楚每个控制器控制着温度、水分和养料中的哪些因素。<br/>
            你可以通过"重置"键来重置所有组件。<br/>
            在下方将控制器和你认为其控制的对象连上线。<br/>
            <b>连线的操作是</b>：点击一个控制器方块，然后点击另一个温度、水分或养料方块。<br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            ...
            <div
              class="influence-box"
              :class="{ 'selected-box': selectedControl === 'fertilizer' }"
              @click="handleBoxClick('fertilizer')"
            >
              养料
            </div>
          </div>
  ...
  <script>
  import FlowerGardenUpComponent from './flower_garden_up_component.vue';
