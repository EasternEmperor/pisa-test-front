    ...
    <div class="perfume-maker-t1">
      ...
      <div class="container-box question-section">
        <div class="question-text">
          <h3>问题1: 控制器功能</h3>
          <p>
            通过改变滑块并应用，弄清楚每个控制器控制的是浓度还是留存时间。<br/>
            你可以通过"重置"键来重置所有组件。<br/>
            在下方将控制器和你认为其控制的对象连上线。<br/>
            连线的操作是：点击一个控制器方块，然后点击另一个浓度/留存时间方块。分别点击已连线的两个方块可取消它们之间的连线。
          </p>
        </div>
        <div class="diagram-section">
          ...
          <div class="influences-column">
            <div class="influence-box" @click="handleBoxClick('concentration')">浓度</div>
            <div class="influence-box" @click="handleBoxClick('lastTime')">留存时间</div>
          </div>
        </div>
