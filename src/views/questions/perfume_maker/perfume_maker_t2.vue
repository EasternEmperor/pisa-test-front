<template>
      ...
      <div class="container-box question-section">
        <div class="question-text">
          ...
          <p>
            ...
            灵活运用控制器，将浓度和留存时间调整到目标数值。目标数值如<b>曲线图上方所示。</b><br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            <div class="influence-box" >浓度</div>
            <div class="influence-box" >留存时间</div>
          </div>
        </div>
  ...
  <script>
  import PerfumeMakerUpComponent from './perfume_maker_up_component_t2.vue';
  ...
  export default {
    ...
    methods: {
      drawExample() {
        ...
        this.handleBoxClick('concentration');
        this.handleBoxClick('central');
        this.handleBoxClick('lastTime');
