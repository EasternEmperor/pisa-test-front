<template>
    <div class="sauna-controller-t2">
      ...
      <div class="container-box question-section">
        ...
        <div class="question-text">
          <h3>问题2: 调控房间温度、房间湿度和桑拿时间</h3>
          <p>
            三个控制器及其控制的对象如下图连线所示。<br/>
            灵活运用控制器，将房间温度、房间湿度和桑拿时间调整到目标数值。目标数值如<b>曲线图上方所示。</b><br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            <div class="influence-box" >房间温度</div>
            <div class="influence-box" >房间湿度</div>
            <div class="influence-box" >桑拿时间</div>
          </div>
        </div>
  ...
  <script>
  import SaunaControllerUpComponent from './sauna_controller_up_component_t2.vue';
  import HeaderComponent from '@/components/Header.vue';
  import CountdownTimer from '@/components/CountdownTimer.vue';
  
  export default {
    name: 'SaunaControllerT2',
    components: {
