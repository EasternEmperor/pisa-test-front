<template>
    <div class="sunlight-controller-t2">
      <!-- 使用 Header 组件 -->
      ...
      <div class="container-box question-section">
        ...
        <div class="question-text">
          <h3>问题2: 调控照射面积、照射时间和照射强度</h3>
          <p>
            三个控制器及其控制的对象如下图连线所示。<br/>
            灵活运用控制器，将照射面积、照射时间和照射强度调整到目标数值。目标数值如<b>曲线图上方所示。</b><br/>
        ...
        <div class="diagram-section">
          ...
          <div class="influences-column">
            <div class="influence-box" >照射面积</div>
            <div class="influence-box" >照射时间</div>
            <div class="influence-box" >照射强度</div>
          </div>
        </div>
  ...
  <script>
  import SunlightControllerUpComponent from './sunlight_controller_up_component_t2.vue';
  import HeaderComponent from '@/components/Header.vue';
  import CountdownTimer from '@/components/CountdownTimer.vue';
  
  export default {
    name: 'SunlightControllerT2',
    components: {
    ...
    methods: {
      drawExample() {
        ...
        this.handleBoxClick('strength');
        this.handleBoxClick('central');
        this.handleBoxClick('time');
      ...
      sendEvent(eventType) {
        ...
        const data = {
          tableName: 1,
          htmlName: 'sunlight_controller_t2',
          userName: userName,
          ithAnswer: ithAnswer,
          event: 'ACER_EVENT',
          eventType: eventType,
