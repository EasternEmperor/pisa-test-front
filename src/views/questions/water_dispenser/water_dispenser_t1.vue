<template>
    <div class="water-dispenser-t1">
      ...
      <div class="container-box question-section">
        <div class="question-text">
          <h3>问题1: 控制器功能</h3>
          <p>
            通过改变滑块并调控，弄清楚每个控制器控制着出水总量、出水温度和出水速度中的哪些因素。<br/>
            你可以通过"重置"键来重置所有组件。<br/>
            在下方将控制器和你认为其控制的对象连上线。<br/>
            <b>连线的操作是</b>：点击一个控制器方块，然后点击另一个出水总量、出水温度或出水速度方块。<br/>
  ...
  <script>
  import WaterDispenserUpComponent from './water_dispenser_up_component.vue';
  import HeaderComponent from '@/components/Header.vue';
  
  export default {
    name: 'WaterDispenserT1',
    components: {
